<template>
	<div class="apply-add-private">
		...
		<van-cell-group title="指定收款账户授权函 (彩色扫描件或照片)" style="position: relative;">
			<a href="#" data-url="http://7mnnwj.com0.z0.glb.clouddn.com/7900020120190305103926727EMDKTlND" class="download-template">下载模板</a>
			<van-uploader>
				<div class="uploader-content">
					上传授权函
					<div class="img">
						<img src="/static/image/pay/openpay06.png" />
					</div>
				</div>
			</van-uploader>
		</van-cell-group>
		<van-cell-group title="办学许可证 (彩色扫描件或照片)" class="uploader-content-wrap">
			<van-field v-model="applyPrivate.number" label="办学许可证号" class="number" :placeholder="`请输入办学许可证号`" />
			<van-uploader>
				<div class="uploader-content">
					上传办学许可证
					<div class="img">
						<img src="/static/image/pay/openpay01.png" />
					</div>
				</div>
			</van-uploader>
		</van-cell-group>
		<van-cell-group title="民办非企业登记证 (彩色扫描件或照片)" class="uploader-content-wrap">
			<van-field v-model="applyPrivate.number" label="民办非企业登记证" class="number" :placeholder="`请输入民办非企业登记证号`" />
			<van-uploader>
				<div class="uploader-content">
					上传民办非企业登记证
					<div class="img">
						<img src="/static/image/pay/openpay02.png" />
					</div>
				</div>
			</van-uploader>
		</van-cell-group>
