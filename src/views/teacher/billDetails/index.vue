<template>
	<div class="tercher-bill-details">
		...
		<div v-show="detail.payStatus == 0" class="page-show-fixed-btn">
			<!-- <a href="javascript:;" @click="goToPay(detail.billDetailNum)">打印收据</a> -->
			<a href="javascript:;">打印收据</a>
		</div>
...
.tercher-bill-details {
    .page-show-fixed-btn a {
